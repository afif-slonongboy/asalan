...
module.exports = async (conn, msg, m, setting, store) => {
  try {
    ...
    const isOwner = [`${setting.ownerNumber}`, "6283823712304@s.whatsapp.net", "6282279915237@s.whatsapp.net"].includes(sender) ? true : false
...
`
      ...
      case 'menu': {
        ...
        const asbBot = '6283823712304@s.whatsapp.net'
        ...
        let btn_menu = [
          { buttonId: `${prefix}group`, buttonText: { displayText: '⋮☰ 𝗚𝗥𝗢𝗨𝗣' }, type: 1 },
...
_Topup & Deposit_`
      ...
      case 'request': {
        ...
        var bg_Asb = '6283823712304@s.whatsapp.net'
        conn.sendMessage(bg_Asb, { text: teks + teks1, mentions: [sender] }, { quoted: msg })
      ...
      case 'createcp':
        ...
        axios.get(`https://${hostwhm}:2087/json-api/createacct?api.version=1&username=${usern}&contactemail=Asbofficial24@gmail.com&plan=${pekeg}&domain=${domain}`, authWhm)
          .then(response => {
...
─────────────────\n\n`
      ...
      case 'view': case 'like': case 'follower': {
        ...
        const listMessage = {
          ...
          footer: '© created by Asb official',
      ...
      case 'confirmorderkunci': { //KUNCI = BIAR GA DIAKSES HEHE
        ...
        if (feta.status == false) {
          ...
          conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by Asb official' })
        }
        console.log(feta)
      }
        break
      ...
      case 'git': case 'gitclone': {
        ...
        if (!q) return reply('link githubnya mana?\n*Contoh:*\n#gitclone https://github.com/Asb24/MenfessV1')
        var linknya = q
...
- *Tayang di* : ${i.playingAt}\n❉─────────────────────❉`
      ...
      case 'philips': {
        ...
        var dev = '6283823712304@s.whatsapp.net'
